...
def search_similar(query: str, index: faiss.IndexFlatL2, chunks: list[str], api_key: str, top_k: int = 3) -> list[str]:
...
def main():
    st.set_page_config(page_title="RAG Q&A System - OpenAI", page_icon="📚", layout="wide")

    st.title("📚 RAG Document Q&A System - OpenAI")
